<?php
//This page let an user edit a mpost
include('config.php');
if(isset($_GET['id'], $_GET['id2']))
{
	//get id and id2 of post
	$id = intval($_GET['id']);
	$id2 = intval($_GET['id2']);
//check if user is logged in
if(isset($_SESSION['username']))
{
	//fetch data related to that post
...
if($dn1['nb1']>0)
{
//check if the message is made by that user or check if user is admin
...
<?php
//if user changes a message, update the database
...
//display old values
?>
<form action="edit_post.php?id=<?php echo $id; ?>&id2=<?php echo $id2; ?>" method="post">
<?php
