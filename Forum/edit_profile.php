...
<?php
	...
	if(isset($_POST['username'], $_POST['password'], $_POST['passverif'], $_POST['email']))
	{
		...
		{
			//check whether password is greater than 6 characters
			if(strlen($_POST['password'])>=6)
			{
				//check for grammer of email
...
//after editing profile log out user
?>
...
<?php
	...
	if($form)
	{
		...
		if(isset($message))
		{
			echo '<strong><p align="center"><font color="red">'.$message.'</font></p></strong>';
		}
		...
		{
			$dnn = mysql_fetch_array(mysql_query('select username,email from users where username="'.$_SESSION['username'].'"'));
...
?>
    <form action="edit_profile.php" method="post">
        ...
        <div class="center">
            <label for="username">Username</label><input type="text" name="username" id="username" value="<?php echo $username; ?>" disabled="disabled"/><br />
            <label for="password">Password<span class="small">(6 characters min.)</span></label><input type="password" name="password" maxlength=20 placeholder="password" id="password" value="<?php echo $password; ?>" /><br />
            <label for="passverif">Password<span class="small">(verification)</span></label><input type="password" name="passverif" maxlength=20 placeholder="verify password" id="passverif" value="<?php echo $password; ?>" /><br />
